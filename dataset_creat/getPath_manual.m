...
rec_base_path='/media/vim/941bfed3-dbb1-4e73-80a7-a5601b4f9505/Wangweiwei/weiwei/pointcloud/code/Enhancement_MPEG/data/OriData_train/OriData_train_rec/';
h5_train='/media/vim/941bfed3-dbb1-4e73-80a7-a5601b4f9505/Wangweiwei/weiwei/pointcloud/code/Enhancement_MPEG/data/TrainData/r06_manual/train/';
...
for i=1:sequence_number 
    ...
    h5create([h5_train,ori_onlyName,'.h5'],'/data_snake',[32,32,3,train_sample]);
    h5create([h5_train,ori_onlyName,'.h5'],'/label_snake',[32,32,3,train_sample]);
    h5create([h5_train,ori_onlyName,'.h5'],'/data_hui',[32,32,3,train_sample]);
    h5create([h5_train,ori_onlyName,'.h5'],'/label_hui',[32,32,3,train_sample]);
    h5create([h5_test,ori_onlyName,'.h5'],'/data_snake',[32,32,3,test_sample]);
    h5create([h5_test,ori_onlyName,'.h5'],'/label_snake',[32,32,3,test_sample]);
    h5create([h5_test,ori_onlyName,'.h5'],'/data_hui',[32,32,3,test_sample]);
    h5create([h5_test,ori_onlyName,'.h5'],'/label_hui',[32,32,3,test_sample]);
    box_label_train_hui=zeros(32,32,3,train_sample);
    box_data_train_hui=zeros(32,32,3,train_sample);
    box_label_train_snake=zeros(32,32,3,train_sample);
    box_data_train_snake=zeros(32,32,3,train_sample);
    box_label_test_hui=zeros(32,32,3,test_sample);
    box_data_test_hui=zeros(32,32,3,test_sample);     % placeholder for all the data
    box_label_test_snake=zeros(32,32,3,test_sample);
    box_data_test_snake=zeros(32,32,3,test_sample);   
    ...
    for j=1:num_Sample
        ...
        curPatchCol_ori_snake=reshape(curPatchCol_ori,[32,32,3]);
        ...
        curPatchCol_rec_snake=reshape(curPatchCol_rec,[32,32,3]);
        ...
        if(j<=train_sample)
             ...
             box_label_test_snake(:,:,:,f)=curPatchCol_ori_snake;
             box_data_test_snake(:,:,:,f)=curPatchCol_rec_snake;
             box_label_test_hui(:,:,:,f)=curPatchCol_ori_hui;
             box_data_test_hui(:,:,:,f)=curPatchCol_rec_hui;
            f=f+1;
        end
    ...
    h5write([h5_train,ori_onlyName,'.h5'],'/data_hui',box_data_train_hui);
    h5write([h5_train,ori_onlyName,'.h5'],'/label_hui',box_label_train_hui);
    h5write([h5_test,ori_onlyName,'.h5'],'/data_snake',box_data_test_snake);
    h5write([h5_test,ori_onlyName,'.h5'],'/label_snake',box_label_test_snake);
    h5write([h5_test,ori_onlyName,'.h5'],'/data_hui',box_data_test_hui);
    h5write([h5_test,ori_onlyName,'.h5'],'/label_hui',box_label_test_hui);
end
close(h1);