...
rec_base_path='data_rec_test_2023/';
h5_train='h5_test/';
...
for i=1:sequence_number
    for jj=1:length(rate)
        ...
        h5create([h5_train,ori_onlyName,rate{jj},'.h5'],'/data_snake',[32,32,3,num_Sample]);
        h5create([h5_train,ori_onlyName,rate{jj},'.h5'],'/label_snake',[32,32,3,num_Sample]);
        box_label_train_snake=zeros(32,32,3,num_Sample);
        box_data_train_snake=zeros(32,32,3,num_Sample); 
        ...
        clear f;
        h5write([h5_train,ori_onlyName,rate{jj},'.h5'],'/data_snake',box_data_train_snake);
        h5write([h5_train,ori_onlyName,rate{jj},'.h5'],'/label_snake',box_label_train_snake);
