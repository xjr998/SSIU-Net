clear;
clc,close all;
ori_path='D:\Wang_Weiwei\Enhancement_MPEG\dataset_creat\data_ori\';
rec_base_path='D:\Wang_Weiwei\Enhancement_MPEG\dataset_creat\LT\data_rec\';
h5_train='h5/';
txt_path='D:\Wang_Weiwei\Enhancement_MPEG\dataset_creat\data_ori\trainFile.txt';
% 
...
%         ori=pcread([ori_path,ori_onlyName,'_real',rate{jj},'.ply']);
        ...
        h5create([h5_train,ori_onlyName,rate{jj},'.h5'],'/data_hui',[32,32,3,num_Sample]);
        h5create([h5_train,ori_onlyName,rate{jj},'.h5'],'/label_hui',[32,32,3,num_Sample]);
        box_label_train_hui=zeros(32,32,3,num_Sample);
        box_data_train_hui=zeros(32,32,3,num_Sample);
