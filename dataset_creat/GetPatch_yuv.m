...
rec_path='/media/vim/941bfed3-dbb1-4e73-80a7-a5601b4f9505/Wangweiwei/weiwei/pointcloud/code/Enhancement_MPEG/data/OriData_train/OriData_train_rec_r01/';
...
h5_train='/media/vim/941bfed3-dbb1-4e73-80a7-a5601b4f9505/Wangweiwei/weiwei/pointcloud/code/Enhancement_MPEG/data/TrainData/r01_y/';
...
%     test_sample=num_Sample-train_sample;
    ...
    %rec_path=[ori_path,'OriData_train_rec_r01/'];
    rec=pcread([rec_path,rec_onlyName,'.ply']);
    rec_color=rec.Color;
    rec_color_yuv=rgb2yuv(rec_color);
    rec_loc=rec.Location;
%     h5create([h5_train,ori_onlyName,'.h5'],'/data_snake',[32,32,1,num_Sample]);
%     h5create([h5_train,ori_onlyName,'.h5'],'/label_snake',[32,32,1,num_Sample]);
    h5create([h5_train,ori_onlyName,'.h5'],'/data',[1024,1,num_Sample]);
    h5create([h5_train,ori_onlyName,'.h5'],'/label',[1024,1,num_Sample]);
    box_label_train=zeros(1024,1,num_Sample);
    box_data_train=zeros(1024,1,num_Sample);
...
%     box_data_train_snake=zeros(32,32,1,num_Sample); 
    ...
    for j=1:num_Sample
        ...
        curPatchLoc_ori=ori_loc(curPatchIdx_ori,:);  % 1024*3
